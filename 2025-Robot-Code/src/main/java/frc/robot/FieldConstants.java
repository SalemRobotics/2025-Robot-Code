...
public class FieldConstants {
    ...
    public static class Reef {
        ...
        public static final Pose2d[] centerFaces = new Pose2d[12]; // Starting facing the driver station in clockwise
                                                                   // order
            ...
            for (int face = 0; face < centerFaces.length; face++) {
                ...
                for (var level : ReefHeight.values()) {
                    ...
                    if (face < 6) {
                        ...
                        poseDirection = new Pose2d(centerOfReef.rotateAround(fieldCenter, Rotation2d.k180deg),
