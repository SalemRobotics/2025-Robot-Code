...
public class DriveCommands {
     ...
     * @param ySupplier supplier for moving forward/backward relative to the position being approached
     * @param approachSupplier A supplier of a Pose2d facing AWAY from the target drivetrain that the drivetrain will approach
