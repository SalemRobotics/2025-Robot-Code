...
import static frc.robot.util.phoenix.PhoenixUtil.*;
...
public class ModuleIOTalonFX implements ModuleIO {
  ...
  public ModuleIOTalonFX(
    ...
    turnConfig.MotionMagic.MotionMagicAcceleration =
        turnConfig.MotionMagic.MotionMagicCruiseVelocity * 7.5;
    ...
    drivePositionQueue =
        PhoenixOdometryThread.getInstance().registerSignal(drivePosition, driveVelocity);
    ...
    turnPositionQueue =
        PhoenixOdometryThread.getInstance().registerSignal(turnPosition, turnVelocity);
